...
<html lang="pt-br">
    ...
    <body>
                    ...
                    <div class="container-sw">
                        <div class="nav-wrapper">
                            <a href="#menu" class="brand-logo">
                                <img src="img/logo-home.png" class="responsive-img logo-mobile-sw">
                            </a>
                ...
                <div class="container-sw">
                    <div class="row">
                        <div class="col s12 m6 l6 xl6"><!--Imagem-->
                            <img src="img/img-sw-sobre.png" class="responsive-img" alt="Star Wars">
                        </div>
                        ...
                        <div class="col s12 m4 l4 xl4">
                            <a href="#">
                                <figure  class="text-noticias-sw grow">
                                    <img class="responsive-img" src="img/sw-noticias.png">
        ...
        <footer><!--Rodapé-->
            <div class="container-sw">
                <div class="row">
                    <div class="col s12 nav-sw">
                       <a href="#menu">
                            <img src="img/logo-rodape-sw.png" alt="Star Wars" class="responsive-img">
                       </a> 
                    </div>
                    <div class="col s12">
                        <div class="center-align text-rodape-sw">
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js"></script><!--Materialize 1.0-->
        <script src="lib/js//EasePack.min.js"></script><!--Ease Pack-->
        <script src="lib/js/TweenLite.min.js"></script><!--Tween Lite-->
